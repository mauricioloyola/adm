...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'sg111.servergrove.com', 'port' => NULL, 'dbname' => 'movibidi_lograrme', 'user' => 'movib_lograrme', 'password' => '106ram3adm1n', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\App\\Bundle\\BackendBundle\\Resources\\config\\doctrine') => 'App\\Bundle\\BackendBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'App\\Bundle\\BackendBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('BackendBundle' => 'App\\Bundle\\BackendBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d68e4a17f554d1fd58df84318f47f7daea725e0918f8d22eb00ff713b2c185fc');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('no-reply@lograrme.com');
        $a->setPassword('n0791y');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('smtp.lograrme.com');
        $instance->setPort(25);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('global', array('name_web' => 'ADMIN Lograrme', 'company' => 'TECLOY Tecnología & Servicios E.I.R.L', 'year' => '2015', 'directorio_css' => 'bundles/backend/dist/css/', 'directorio_css_bootstrap' => 'bundles/backend/bootstrap/css/', 'directorio_css_font_awesome' => 'bundles/backend/font-awesome/4.3.0/css/', 'directorio_css_ionicons' => 'bundles/backend/ionicons/2.0.0/css/', 'directorio_js' => 'bundles/backend/dist/js/', 'directorio_js_bootstrap' => 'bundles/backend/bootstrap/js/', 'directorio_plugins' => 'bundles/backend/plugins/', 'directorio_images' => 'bundles/backend/images/', 'directorio_dist_img' => 'bundles/backend/dist/img/', 'idiomas' => array('es' => 'Español', 'en' => 'Inglés', 'it' => 'Italiano'), 'lenguaje' => 'es'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\App\\Bundle\\BackendBundle/Resources/views'), 'Backend');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c39afbbf97f1ef9cd05fff8dea55b43d8556e0ae');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => 'sg111.servergrove.com',
            'database_port' => NULL,
            'database_name' => 'movibidi_lograrme',
            'database_user' => 'movib_lograrme',
            'database_password' => '106ram3adm1n',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.lograrme.com',
            'mailer_user' => 'no-reply@lograrme.com',
            'mailer_password' => 'n0791y',
            'locale' => 'es',
            'secret' => 'c39afbbf97f1ef9cd05fff8dea55b43d8556e0ae',
            'debug_toolbar' => true,
            ...
            'kernel.secret' => 'c39afbbf97f1ef9cd05fff8dea55b43d8556e0ae',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtp.lograrme.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'no-reply@lograrme.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'n0791y',
